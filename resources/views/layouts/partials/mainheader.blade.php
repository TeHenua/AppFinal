...
<header class="main-header">
    ...
    <!-- Header Navbar -->
    <nav class="navbar navbar-static-top" role="navigation" style="background-color:#7d0056">
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <li>
                    <a class="dropdown-toggle" href="{{ url('/logout') }}" ><span class="hidden-xs">Cerrar sesión</span></a>
                </li>
            </ul>
        </div>
    </nav>
